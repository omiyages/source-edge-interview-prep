-- Complete Kanban Setup - Final Version
...
CREATE TABLE IF NOT EXISTS user_stages (
  ...
  stage VARCHAR(100) NOT NULL,  -- Store stage name as text
...
-- STEP 10: Create the main function that works with the actual table structure
...
-- STEP 11: Create move_user_to_stage function

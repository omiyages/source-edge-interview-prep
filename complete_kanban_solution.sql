-- Complete Kanban Solution - Step by Step Setup
-- Run this SQL in your Supabase SQL Editor

-- STEP 1: Create all tables first
-- 1.1 Create stages table
...
-- 1.3 Create stage_transitions table
...
-- 1.4 Create user_rejections table
...
-- 4.3 Stage transitions policies
...
-- STEP 8: Create move_user_to_stage function
...
SELECT 'user_stages' as table_name, COUNT(*) as count FROM user_stages;
SELECT 'profiles' as table_name, COUNT(*) as count FROM profiles;

-- STEP 13: Test the function (only if stages exist)
DO $$
DECLARE
  stage_count INTEGER;
  test_result INTEGER;
BEGIN
  ...
  IF stage_count > 0 THEN
    ...
    RAISE NOTICE 'Function test successful: % users found', test_result;
  ELSE
    RAISE NOTICE 'No stages found - function test skipped';
  END IF;
END $$;

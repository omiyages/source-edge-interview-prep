-- First check current hiring stages
SELECT name, stage_order, order_index FROM public.hiring_stages ORDER BY stage_order;

-- Update existing stages and add new ones
-- Clear existing data and recreate with proper order
DELETE FROM public.hiring_stages;

-- Simple Kanban Fix - No Interviews Table Dependency
-- Run this SQL in your Supabase SQL Editor

-- 1. Create a simple version of get_users_by_stage_with_rejected that doesn't depend on interviews table
...
-- 3. Test the function
SELECT 'Kanban function fixed - no interviews dependency' as status;

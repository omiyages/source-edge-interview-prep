-- Fix kanban board conditional coloring by updating the get_users_by_stage_with_rejected function
...
-- Create the updated function with proper interview and task data fetching

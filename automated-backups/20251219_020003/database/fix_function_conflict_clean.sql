-- Fix Function Conflict - Clean All Versions
...
DROP FUNCTION IF EXISTS get_users_by_stage_with_rejected(p_stage UUID, p_show_rejected BOOLEAN);
DROP FUNCTION IF EXISTS get_users_by_stage_with_rejected(p_stage UUID);

-- 2. Create a single, clean version
...
-- 4. Test the function
SELECT 'Function conflict resolved - single clean version created' as status;

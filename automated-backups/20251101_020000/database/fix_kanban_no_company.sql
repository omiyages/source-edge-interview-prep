-- Simple fix - remove company field from function to get users showing immediately
-- This bypasses the company field issue entirely
...
BEGIN
    ...
    SELECT 
        ...
        p.role::VARCHAR,
        p."position"::VARCHAR,
        'Woven by Toyota'::VARCHAR as company,  -- Hardcoded default
...
-- Check if there are users in user_stages
SELECT 'User stages check:' as test;

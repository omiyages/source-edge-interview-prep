-- Fix Kanban board by updating the function to work without company column
-- This ensures users show up even if company column doesn't exist yet

-- First, add company column if it doesn't exist
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS company TEXT;

-- Update the get_users_by_stage_with_rejected function to handle missing company column

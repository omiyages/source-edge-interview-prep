...
export function VirtualizedKanbanColumn({
  ...
  const renderUser = (user: any, index: number) => (
    <div
      key={user.user_id}
      className="p-2 cursor-pointer hover:bg-neutral-800 rounded-lg transition-colors"
      onClick={() => onUserClick(user)}
    >
      <div className="bg-neutral-900 border rounded-lg p-3 shadow-sm">
  ...
  return (
    <div className="h-full">
      <div className="p-3 border-b">
        ...
        <span className="text-xs text-neutral-400">{column.users.length} users</span>
      </div>

-- Simple fix for Kanban board - create a basic function without company field
-- This ensures users show up immediately

-- Drop the problematic function
DROP FUNCTION IF EXISTS get_users_by_stage_with_rejected(VARCHAR, BOOLEAN);

-- Create a simple version without company field
...
BEGIN
    ...
    SELECT 
        ...
        p.role::TEXT,
        p."position"::TEXT,
        ''::TEXT as company,  -- Empty string for now
